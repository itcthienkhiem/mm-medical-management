...
{
    public partial class uChiSoXetNghiem_Glucose_Hitachi917 : uBase
    {
        #region Members
        ...
        #region Constructor
        public uChiSoXetNghiem_Glucose_Hitachi917()
        {
            InitializeComponent();
        }
        #endregion
        ...
        public void ClearData()
        {
            ...
            chkFromValue_Chung_Sau2h.Checked = false;
            numFromValue_Chung_Sau2h.Value = 0;
            chkToValue_Chung_Sau2h.Checked = false;
            numToValue_Chung_Sau2h.Value = 0;
            ...
            chkFromValue_Nam_Sau2h.Checked = false;
            numFromValue_Nam_Sau2h.Value = 0;
            chkToValue_Nam_Sau2h.Checked = false;
            numToValue_Nam_Sau2h.Value = 0;
            ...
            chkFromValue_Nu_Sau2h.Checked = false;
            numFromValue_Nu_Sau2h.Value = 0;
            chkToValue_Nu_Sau2h.Checked = false;
            numToValue_Nu_Sau2h.Value = 0;
            ...
            chkFromValue_TreEm_Sau2h.Checked = false;
            numFromValue_TreEm_Sau2h.Value = 0;
            chkToValue_TreEm_Sau2h.Checked = false;
            numToValue_TreEm_Sau2h.Value = 0;
            ...
            chkFromValue_NguoiLon_Sau2h.Checked = false;
            numFromValue_NguoiLon_Sau2h.Value = 0;
            chkToValue_NguoiLon_Sau2h.Checked = false;
            numToValue_NguoiLon_Sau2h.Value = 0;
            ...
            chkFromValue_NguoiCaoTuoi_Sau2h.Checked = false;
            numFromValue_NguoiCaoTuoi_Sau2h.Value = 0;
            chkToValue_NguoiCaoTuoi_Sau2h.Checked = false;
            numToValue_NguoiCaoTuoi_Sau2h.Value = 0;
        }
        ...
        public bool CheckInfo()
        {
            if (raChung.Checked)
            {
                ...
                if (!chkFromValue_Chung_Sau2h.Checked && !chkToValue_Chung_Sau2h.Checked)
                {
                    MsgBox.Show(Application.ProductName, "Vui lòng nhập ít nhất 1 trong 2 chỉ số.", IconType.Information);
                    chkFromValue_Chung_Sau2h.Focus();
                    return false;
                }

                if (chkFromValue_Chung_Sau2h.Checked && chkToValue_Chung_Sau2h.Checked)
                {
                    if (numFromValue_Chung_Sau2h.Value > numToValue_Chung_Sau2h.Value)
                    {
                        MsgBox.Show(Application.ProductName, "Chỉ số từ phải nhỏ hơn hoặc bằng chỉ số đến.", IconType.Information);
                        numFromValue_Chung_Sau2h.Focus();
                        return false;
                    }
                }
            }
            else if (raNamNu.Checked)
            {
                ...
                if (chkNam.Checked)
                {
                    ...
                    if (!chkFromValue_Nam_Sau2h.Checked && !chkToValue_Nam_Sau2h.Checked)
                    {
                        MsgBox.Show(Application.ProductName, "Vui lòng nhập ít nhất 1 trong 2 chỉ số.", IconType.Information);
                        chkFromValue_Nam_Sau2h.Focus();
                        return false;
                    }

                    if (chkFromValue_Nam_Sau2h.Checked && chkToValue_Nam_Sau2h.Checked)
                    {
                        if (numFromValue_Nam_Sau2h.Value > numToValue_Nam_Sau2h.Value)
                        {
                            MsgBox.Show(Application.ProductName, "Chỉ số từ phải nhỏ hơn hoặc bằng chỉ số đến.", IconType.Information);
                            numFromValue_Nam_Sau2h.Focus();
                            return false;
                        }
                    }
                }
                ...
                if (chkNu.Checked)
                {
                    ...
                    if (!chkFromValue_Nu_Sau2h.Checked && !chkToValue_Nu_Sau2h.Checked)
                    {
                        MsgBox.Show(Application.ProductName, "Vui lòng nhập ít nhất 1 trong 2 chỉ số.", IconType.Information);
                        chkFromValue_Nu_Sau2h.Focus();
                        return false;
                    }

                    if (chkFromValue_Nu_Sau2h.Checked && chkToValue_Nu_Sau2h.Checked)
                    {
                        if (numFromValue_Nu_Sau2h.Value > numToValue_Nu_Sau2h.Value)
                        {
                            MsgBox.Show(Application.ProductName, "Chỉ số từ phải nhỏ hơn hoặc bằng chỉ số đến.", IconType.Information);
                            numFromValue_Nu_Sau2h.Focus();
                            return false;
                        }
                    }
                }
            ...
            else
            {
                ...
                if (chkTreEm.Checked)
                {
                    ...
                    if (!chkFromValue_TreEm_Sau2h.Checked && !chkToValue_TreEm_Sau2h.Checked)
                    {
                        MsgBox.Show(Application.ProductName, "Vui lòng nhập ít nhất 1 trong 2 chỉ số.", IconType.Information);
                        chkFromValue_TreEm_Sau2h.Focus();
                        return false;
                    }

                    if (chkFromValue_TreEm_Sau2h.Checked && chkToValue_TreEm_Sau2h.Checked)
                    {
                        if (numFromValue_TreEm_Sau2h.Value > numToValue_TreEm_Sau2h.Value)
                        {
                            MsgBox.Show(Application.ProductName, "Chỉ số từ phải nhỏ hơn hoặc bằng chỉ số đến.", IconType.Information);
                            numFromValue_TreEm_Sau2h.Focus();
                            return false;
                        }
                    }
                }
                ...
                if (chkNguoiLon.Checked)
                {
                    ...
                    if (!chkFromValue_NguoiLon_Sau2h.Checked && !chkToValue_NguoiLon_Sau2h.Checked)
                    {
                        MsgBox.Show(Application.ProductName, "Vui lòng nhập ít nhất 1 trong 2 chỉ số.", IconType.Information);
                        chkFromValue_NguoiLon_Sau2h.Focus();
                        return false;
                    }

                    if (chkFromValue_NguoiLon_Sau2h.Checked && chkToValue_NguoiLon_Sau2h.Checked)
                    {
                        if (numFromValue_NguoiLon_Sau2h.Value > numToValue_NguoiLon_Sau2h.Value)
                        {
                            MsgBox.Show(Application.ProductName, "Chỉ số từ phải nhỏ hơn hoặc bằng chỉ số đến.", IconType.Information);
                            numFromValue_NguoiLon_Sau2h.Focus();
                            return false;
                        }
                    }
                }
                ...
                if (chkNguoiCaoTuoi.Checked)
                {
                    ...
                    if (!chkFromValue_NguoiCaoTuoi_Sau2h.Checked && !chkToValue_NguoiCaoTuoi_Sau2h.Checked)
                    {
                        MsgBox.Show(Application.ProductName, "Vui lòng nhập ít nhất 1 trong 2 chỉ số.", IconType.Information);
                        chkFromValue_NguoiCaoTuoi_Sau2h.Focus();
                        return false;
                    }

                    if (chkFromValue_NguoiCaoTuoi_Sau2h.Checked && chkToValue_NguoiCaoTuoi_Sau2h.Checked)
                    {
                        if (numFromValue_NguoiCaoTuoi_Sau2h.Value > numToValue_NguoiCaoTuoi_Sau2h.Value)
                        {
                            MsgBox.Show(Application.ProductName, "Chỉ số từ phải nhỏ hơn hoặc bằng chỉ số đến.", IconType.Information);
                            numFromValue_NguoiCaoTuoi_Sau2h.Focus();
                            return false;
                        }
                    }
                }
            ...
            try
            {
                MethodInvoker method = delegate
                {
                    ...
                    if (raChung.Checked)
                    {
                        ...
                        if (chkFromValue_Chung_Sau2h.Checked) ctxn.FromValue = (double)numFromValue_Chung_Sau2h.Value;
                        if (chkToValue_Chung_Sau2h.Checked) ctxn.ToValue = (double)numToValue_Chung_Sau2h.Value;
                    ...
                    else if (raNamNu.Checked)
                    {
                        if (chkNam.Checked)
                        {
                            ...
                            if (chkFromValue_Nam_Sau2h.Checked) ctxn.FromValue = (double)numFromValue_Nam_Sau2h.Value;
                            if (chkToValue_Nam_Sau2h.Checked) ctxn.ToValue = (double)numToValue_Nam_Sau2h.Value;
                        ...
                        if (chkNu.Checked)
                        {
                            ...
                            if (chkFromValue_Nu_Sau2h.Checked) ctxn.FromValue = (double)numFromValue_Nu_Sau2h.Value;
                            if (chkToValue_Nu_Sau2h.Checked) ctxn.ToValue = (double)numToValue_Nu_Sau2h.Value;
                    ...
                    else
                    {
                        if (chkTreEm.Checked)
                        {
                            ...
                            if (chkFromValue_TreEm_Sau2h.Checked) ctxn.FromValue = (double)numFromValue_TreEm_Sau2h.Value;
                            if (chkToValue_TreEm_Sau2h.Checked) ctxn.ToValue = (double)numToValue_TreEm_Sau2h.Value;
                        ...
                        if (chkNguoiLon.Checked)
                        {
                            ...
                            if (chkFromValue_NguoiLon_Sau2h.Checked) ctxn.FromValue = (double)numFromValue_NguoiLon_Sau2h.Value;
                            if (chkToValue_NguoiLon_Sau2h.Checked) ctxn.ToValue = (double)numToValue_NguoiLon_Sau2h.Value;
                        ...
                        if (chkNguoiCaoTuoi.Checked)
                        {
                            ...
                            if (chkFromValue_NguoiCaoTuoi_Sau2h.Checked) ctxn.FromValue = (double)numFromValue_NguoiCaoTuoi_Sau2h.Value;
                            if (chkToValue_NguoiCaoTuoi_Sau2h.Checked) ctxn.ToValue = (double)numToValue_NguoiCaoTuoi_Sau2h.Value;
        ...
        private void chkNam_CheckedChanged(object sender, EventArgs e)
        {
            ...
            chkFromValue_Nam_Sau2h.Enabled = chkNam.Checked;
            chkToValue_Nam_Sau2h.Enabled = chkNam.Checked;
            //txtDonVi_Nam_Sau2h.Enabled = chkNam.Checked;

            numFromValue_Nam_Sau2h.Enabled = chkNam.Checked && chkFromValue_Nam_Sau2h.Checked;
            numToValue_Nam_Sau2h.Enabled = chkNam.Checked && chkToValue_Nam_Sau2h.Checked;
        }
        ...
        private void chkNu_CheckedChanged(object sender, EventArgs e)
        {
            ...
            chkFromValue_Nu_Sau2h.Enabled = chkNu.Checked;
            chkToValue_Nu_Sau2h.Enabled = chkNu.Checked;
            //txtDonVi_Nu_Sau2h.Enabled = chkNu.Checked;

            numFromValue_Nu_Sau2h.Enabled = chkNu.Checked && chkFromValue_Nu_Sau2h.Checked;
            numToValue_Nu_Sau2h.Enabled = chkNu.Checked && chkToValue_Nu_Sau2h.Checked;
        }
        ...
        private void chkTreEm_CheckedChanged(object sender, EventArgs e)
        {
            ...
            chkFromValue_TreEm_Sau2h.Enabled = chkTreEm.Checked;
            chkToValue_TreEm_Sau2h.Enabled = chkTreEm.Checked;
            //txtDonVi_TreEm_Sau2h.Enabled = chkTreEm.Checked;

            numFromValue_TreEm_Sau2h.Enabled = chkTreEm.Checked && chkFromValue_TreEm_Sau2h.Checked;
            numToValue_TreEm_Sau2h.Enabled = chkTreEm.Checked && chkToValue_TreEm_Sau2h.Checked;
        }
        ...
        private void chkNguoiLon_CheckedChanged(object sender, EventArgs e)
        {
            ...
            chkFromValue_NguoiLon_Sau2h.Enabled = chkNguoiLon.Checked;
            chkToValue_NguoiLon_Sau2h.Enabled = chkNguoiLon.Checked;
            //txtDonVi_NguoiLon_Sau2h.Enabled = chkNguoiLon.Checked;

            numFromValue_NguoiLon_Sau2h.Enabled = chkNguoiLon.Checked && chkFromValue_NguoiLon_Sau2h.Checked;
            numToValue_NguoiLon_Sau2h.Enabled = chkNguoiLon.Checked && chkToValue_NguoiLon_Sau2h.Checked;
        }
        ...
        private void chkNguoiCaoTuoi_CheckedChanged(object sender, EventArgs e)
        {
            ...
            chkFromValue_NguoiCaoTuoi_Sau2h.Enabled = chkNguoiCaoTuoi.Checked;
            chkToValue_NguoiCaoTuoi_Sau2h.Enabled = chkNguoiCaoTuoi.Checked;
            //txtDonVi_NguoiCaoTuoi_Sau2h.Enabled = chkNguoiCaoTuoi.Checked;

            numFromValue_NguoiCaoTuoi_Sau2h.Enabled = chkNguoiCaoTuoi.Checked && chkFromValue_NguoiCaoTuoi_Sau2h.Checked;
            numToValue_NguoiCaoTuoi_Sau2h.Enabled = chkNguoiCaoTuoi.Checked && chkToValue_NguoiCaoTuoi_Sau2h.Checked;
        }
        ...
        private void chkFromValue_Chung_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numFromValue_Chung_Sau2h.Enabled = chkFromValue_Chung_Sau2h.Checked;
        }

        private void chkToValue_Chung_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numToValue_Chung_Sau2h.Enabled = chkToValue_Chung_Sau2h.Checked;
        }

        private void chkFromValue_Nam_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numFromValue_Nam_Sau2h.Enabled = chkFromValue_Nam_Sau2h.Checked;
        }

        private void chkToValue_Nam_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numToValue_Nam_Sau2h.Enabled = chkToValue_Nam_Sau2h.Checked;
        }

        private void chkFromValue_Nu_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numFromValue_Nu_Sau2h.Enabled = chkFromValue_Nu_Sau2h.Checked;
        }

        private void chkToValue_Nu_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numToValue_Nu_Sau2h.Enabled = chkToValue_Nu_Sau2h.Checked;
        }

        private void chkFromValue_TreEm_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numFromValue_TreEm_Sau2h.Enabled = chkFromValue_TreEm_Sau2h.Checked;
        }

        private void chkToValue_TreEm_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numToValue_TreEm_Sau2h.Enabled = chkToValue_TreEm_Sau2h.Checked;
        }

        private void chkFromValue_NguoiLon_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numFromValue_NguoiLon_Sau2h.Enabled = chkFromValue_NguoiLon_Sau2h.Checked;
        }

        private void chkToValue_NguoiLon_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numToValue_NguoiLon_Sau2h.Enabled = chkToValue_NguoiLon_Sau2h.Checked;
        }

        private void chkFromValue_NguoiCaoTuoi_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numFromValue_NguoiCaoTuoi_Sau2h.Enabled = chkFromValue_NguoiCaoTuoi_Sau2h.Checked;
        }

        private void chkToValue_NguoiCaoTuoi_Sau2h_CheckedChanged(object sender, EventArgs e)
        {
            numToValue_NguoiCaoTuoi_Sau2h.Enabled = chkToValue_NguoiCaoTuoi_Sau2h.Checked;
        }
