...
namespace MM.Controls
{
    public partial class uKetQuaXetNghiemTay : uBase
    {
        ...
        private string GetCurrentXetNghiem()
        {
            ...
            if (drXetNghiem["KetQuaXetNghiemManualGUID"] != null && drXetNghiem["KetQuaXetNghiemManualGUID"] != DBNull.Value)
                xetNghiemGUID = drXetNghiem["KetQuaXetNghiemManualGUID"].ToString();
        ...
        private void SetCurrentXetNghiem(string xetNghiemGUID)
        {
            foreach (DataGridViewRow row in dgXetNghiem.Rows)
            {
                ...
                if (dr["KetQuaXetNghiemManualGUID"] == null || dr["KetQuaXetNghiemManualGUID"] == DBNull.Value) continue;

                if (dr["KetQuaXetNghiemManualGUID"].ToString().Trim().ToUpper() == xetNghiemGUID.Trim().ToUpper())
                {
                    if (row.Index > 0)
                    {
