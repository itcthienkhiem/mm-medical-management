...
namespace DicomImageViewer
{
    public partial class WindowLevelGraphControl : UserControl
    {
        ...
        void DrawLines(Graphics g)
        {
            ...
            //distFromOrig1 = Convert.ToInt32(winMin * graphWidth / winWidth);
            //distFromOrig2 = Convert.ToInt32(winMax * graphWidth / winWidth);
        ...
        private void WindowLevelControl_Paint(object sender, PaintEventArgs e)
        {
            ...
            // For display purposes the window centre, win min and win max are to be re-calculated
            // This recalculation is required for signed images only
