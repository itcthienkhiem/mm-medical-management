    ...
    public class KetQuaXetNghiemTongHopBus : BusBase
    {
        ...
        public static Result GetKetQuaXetNghiemTongHopList(DateTime fromDate, DateTime toDate, string patientGUID, string ngaySinh, string gioiTinh)
        {
            ...
            try
            {
                ...
                //Hitachi917
                query = string.Format("SELECT CAST(0 AS Bit) AS Checked, ChiTietKQXN_Hitachi917GUID AS ChiTietKQXNGUID, XetNghiemGUID, NgayXN, Fullname, TestResult, '' AS TestPercent, TinhTrang, '' AS BinhThuong, [Type] FROM dbo.ChiTietKetQuaXetNghiem_Hitachi917View WHERE Status={0} AND KQXNStatus={0} AND PatientGUID='{1}' AND NgayXN BETWEEN '{2}' AND '{3}' ORDER BY NgayXN, Fullname",
                ...
                query = string.Format("SELECT CAST(0 AS Bit) AS Checked, ChiTietKQXN_CellDyn3200GUID AS ChiTietKQXNGUID, '{4}' AS XetNghiemGUID, NgayXN, Fullname, TestResult, TestPercent, TinhTrang, '' AS BinhThuong, [Type] FROM dbo.ChiTietKetQuaXetNghiem_CellDyn3200View WHERE Status={0} AND KQXNStatus={0} AND PatientGUID='{1}' AND NgayXN BETWEEN '{2}' AND '{3}' ORDER BY GroupID, [Order], NgayXN",
                ...
                //Xet nghiem tay
                query = string.Format("SELECT CAST(0 AS Bit) AS Checked, ChiTietKetQuaXetNghiem_ManualGUID AS ChiTietKQXNGUID, XetNghiem_ManualGUID AS XetNghiemGUID, NgayXN, Fullname, TestResult, '' AS TestPercent, TinhTrang, '' AS BinhThuong, [Type] FROM dbo.ChiTietKetQuaXetNghiem_ManualView WHERE Status={0} AND KQXNStatus={0} AND PatientGUID='{1}' AND NgayXN BETWEEN '{2}' AND '{3}' ORDER BY NgayXN, Fullname",
                    (byte)Status.Actived, patientGUID, fromDate.ToString("yyyy-MM-dd 00:00:00"), toDate.ToString("yyyy-MM-dd 23:59:59"));
        ...
        public static Result GetKetQuaXetNghiemCellDyn3200List(DateTime fromDate, DateTime toDate, string patientGUID, string ngaySinh, string gioiTinh)
        {
            ...
            try
            {
                ...
                //Celldyn3200
                string emptyGUID = Guid.Empty.ToString();
                query = string.Format("SELECT CAST(0 AS Bit) AS Checked, ChiTietKQXN_CellDyn3200GUID AS ChiTietKQXNGUID, '{4}' AS XetNghiemGUID, NgayXN, Fullname, TestResult, TestPercent, TinhTrang, '' AS BinhThuong, [Type], GroupID, [Order] FROM dbo.ChiTietKetQuaXetNghiem_CellDyn3200View WHERE Status={0} AND KQXNStatus={0} AND PatientGUID='{1}' AND NgayXN BETWEEN '{2}' AND '{3}' ORDER BY GroupID, [Order], NgayXN",
                    (byte)Status.Actived, patientGUID, fromDate.ToString("yyyy-MM-dd 00:00:00"), toDate.ToString("yyyy-MM-dd 23:59:59"), emptyGUID);
